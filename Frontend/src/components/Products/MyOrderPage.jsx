      ...
      <div style={{ fontFamily: "'Montserrat', sans-serif", background: "#111", minHeight: "100vh" }}>
        ...
        <div className="max-w-5xl mx-auto px-6 py-16">
          <div className="mb-12">
            ...
            <h1 style={{ fontFamily: "'Cormorant Garamond', serif" }} className="text-5xl font-light text-white mb-3">
              Order History
            </h1>
          ...
          <div className="grid grid-cols-3 gap-4 mb-12">
            {[
              ...
              >
                <p style={{ fontFamily: "'Cormorant Garamond', serif", color: "#c9a96e" }} className="text-5xl font-light mb-2">
                  {stat.value}
                </p>
            ...
            {orders.map((order) => (
              ...
              >
                <div className="flex items-center gap-6 p-5">
                  <img
                    src={order.orderItems?.[0]?.image || "https://placehold.co/500x500?text=Order"}
